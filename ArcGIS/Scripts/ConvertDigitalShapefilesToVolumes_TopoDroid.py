...
Source data should come from TopoDroid
...
"""
thFolder = "C:\\Users\\JONZET\\Documents\\Data\\Maps\\ArrhythmiaCave\\Notes\\SurveyData\\20220320\\20220320\\"
crs = arcpy.SpatialReference(26916)
newAppend = "No"
#Yes to create mapping feature class tempaltes
...
#Format survey data
arcpy.CalculateField_management(shots, "_SPLAY", '!_DUPLICATE!', "PYTHON3")
...
splays = arcpy.FeatureClassToFeatureClass_conversion(shots, fileGDB, "SplayShots", '"_DUPLICATE" = 1')
